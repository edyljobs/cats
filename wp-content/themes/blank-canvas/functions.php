...
function cats_enqueue_styles() {
	wp_enqueue_style( 'cats-style', get_template_directory_uri() . '/assets/css/cat_styles.css');
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css');
}
add_action('wp_enqueue_scripts', 'cats_enqueue_styles');


function cats_custom_javascript() {
	wp_enqueue_script( 'jquery-script', get_template_directory_uri() . '/assets/js/jquery-3.4.1.slim.min.js', array(), null, true );
